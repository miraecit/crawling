...
(async () => {
    const brw = await puppeteer.launch({headless: false, args: ["--window-size=10,1080", "--window-position=0,0"]})
    ...
    while (true) {
        const url = pagenation === 1 ? 
            ...
            'https://www.mining.com/commodity/copper/page/' + pagenation + '/#latest-section'
